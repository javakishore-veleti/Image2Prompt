...
class IKbFacade(ABC):
    ...
    @abstractmethod
    def create_ingest_job(self, req: "dto.CreateIngestJobReq") -> "dto.IngestJobResp": ...

    @abstractmethod
    def get_ingest_job(self, req: "dto.GetIngestJobReq") -> "dto.IngestJobResp": ...

    @abstractmethod
    async def run_ingest_job(self, req: "dto.RunIngestJobReq") -> "dto.IngestJobResp": ...
    ...
    @abstractmethod
    async def my_subscription(self, req: "dto.MySubscriptionReq") -> "dto.MySubscriptionResp": ...
